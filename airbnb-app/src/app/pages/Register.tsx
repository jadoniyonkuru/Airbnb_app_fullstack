      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-20 py-12 overflow-y-auto">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <button className="flex items-center justify-center gap-2 border border-[#DDDDDD] rounded-xl py-3.5 px-8 hover:bg-[#F7F7F7] transition-colors text-sm text-[#222222] font-medium">
